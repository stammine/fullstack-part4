...
describe('total likes', () => {
  ...
  test('when list has multiple blogs, their likes are summed', () => {
...
describe('most blogs', () => {
  test('returns the blogger with most blogs', () => {
...
describe('most likes', () => {
  test('returns the blogger with most likes', () => {
